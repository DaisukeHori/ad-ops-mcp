...
export function registerMetaAdsInsightCampaign(server: McpServer): void {
  server.tool(
    "meta_ads_insight_campaign",
    "Meta広告キャンペーンのパフォーマンスインサイト（レポート）を取得します。インプレッション、クリック、コスト等の指標を確認できます。",
    {
